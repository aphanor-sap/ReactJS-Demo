This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app). You can find a live demo [here](https://alexis.gigya-cs.com/react-demo/).
